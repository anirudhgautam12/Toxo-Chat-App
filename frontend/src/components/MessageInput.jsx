...
function MessageInput() {
  ...
  return (
    <div className="w-full p-4 border-t border-slate-700/50">
      ...
      <form onSubmit={handleSendMessage} className="max-w-3xl mx-auto flex space-x-4 items-center">
        <input
          type="text"
          value={text}
          onChange={(e) => {
        ...
        <button
          ...
          className="bg-gradient-to-r from-cyan-500 to-cyan-600 text-white rounded-lg px-4 py-2.5 font-medium hover:from-cyan-600 hover:to-cyan-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
        >
